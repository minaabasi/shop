    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
            ...
            <div class="left side-menu">
                ...
                <div class="left-side-logo d-block d-lg-none">
                    <div class="text-center">
                        ...
                        <a href="index.html" class="logo"><img src="admin/images/logo_dark.png" height="20" alt="logo"></a>
                    </div>
                </div>
            ...
            <div class="content-page">
                ...
                <div class="content">
                    ...
                    <div class="topbar">
                        ...
                        <div class="topbar-left	d-none d-lg-block">
                            <div class="text-center">
                                <a href="index.html" class="logo"><img src="admin/images/logo.png" height="22" alt="logo"></a>
                            </div>
                        </div>
                        ...
                        <nav class="navbar-custom">
                            ...
                            <ul class="list-inline float-right mb-0">
                                ...
                                <li class="list-inline-item dropdown notification-list nav-user">
                                    <a class="nav-link dropdown-toggle arrow-none waves-effect" data-toggle="dropdown" href="#" role="button"
                                    aria-haspopup="false" aria-expanded="false">
                                        <img src="admin/images/users/avatar-6.jpg" alt="user" class="rounded-circle">
                ...
                <footer class="footer">
                    © 2019 Zinzer <span class="d-none d-md-inline-block"> - Downloaded free <i class="mdi mdi-heart text-danger"></i> by MELLATWEB.COM.</span>
                </footer>
